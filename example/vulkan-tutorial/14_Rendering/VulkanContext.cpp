...
void VulkanContext::createSyncObjects() {
    ...
    if (vkCreateSemaphore(m_logicDevice, &semaphoreCreateInfo, nullptr, &m_imageAvailableSemaphore) != VK_SUCCESS ||
        vkCreateSemaphore(m_logicDevice, &semaphoreCreateInfo, nullptr, &m_renderFinishedSemaphore) != VK_SUCCESS ||
        vkCreateFence(m_logicDevice, &fenceCreateInfo, nullptr, &m_inFlightFence) != VK_SUCCESS) {
...
void VulkanContext::drawFrame() {
    ...
    vkAcquireNextImageKHR(m_logicDevice, m_swapChain, UINT64_MAX, m_imageAvailableSemaphore, VK_NULL_HANDLE,
                          &imageIndex);
