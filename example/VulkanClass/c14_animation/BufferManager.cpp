...
namespace VKL
{
    ...
    {
        constexpr VkDescriptorSetLayoutBinding ubo_layout_binding{.binding = 0,
        ...
        std::vector bindings{ubo_layout_binding, sampler_layout_binding};
                                ...
                                const VkDescriptorSetLayout desc_set) const
    {
        ...
        attribute_descriptions.emplace_back(2, 0, VK_FORMAT_R32G32_SFLOAT, offsetof(Vertex, u));
