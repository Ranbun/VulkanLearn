...
public:
    ...
    void submitAndPresent(VkSemaphore waitImage, VkSemaphore waitSubmission, VkFence fenceSubmission,
                          uint32_t imagIndex);
    ...
    void keyPressCallBack(GLFWwindow *window, int key, int scancode, int action, int mods) const;
    void resizeCallBack(GLFWwindow *window, int w, int h) const;
